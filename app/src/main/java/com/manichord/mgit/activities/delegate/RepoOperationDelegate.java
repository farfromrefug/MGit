...
import com.manichord.mgit.activities.delegate.actions.UndoAction;
...
import com.manichord.mgit.activities.delegate.actions.QuickPushAction;
...
import com.manichord.mgit.repo.tasks.repo.CheckoutFileTask;
import com.manichord.mgit.repo.tasks.repo.DeleteFileFromRepoTask;
import com.manichord.mgit.repo.tasks.repo.MergeTask;
...
public class RepoOperationDelegate {
    ...
    public void checkoutCommit(final String commitName) {
        CheckoutTask checkoutTask = new CheckoutTask(mRepo, commitName,
                null, new SheimiAsyncTask.AsyncTaskPostCallback() {
                    @Override
    ...
    public void mergeBranch(final Ref commit, final String ffModeStr,
        ...
        MergeTask mergeTask = new MergeTask(mRepo, commit, ffModeStr,
                autoCommit, new SheimiAsyncTask.AsyncTaskPostCallback() {
                    @Override
                    public void onPostExecute(Boolean isSuccess) {
                        mActivity.reset();
                    }
    ...
    public void deleteFileFromRepo(String filepath,DeleteOperationType deleteOperationType) {
        ...
        DeleteFileFromRepoTask task = new DeleteFileFromRepoTask(mRepo,
                relative,deleteOperationType, new SheimiAsyncTask.AsyncTaskPostCallback() {
                    @Override
                    public void onPostExecute(Boolean isSuccess) {
